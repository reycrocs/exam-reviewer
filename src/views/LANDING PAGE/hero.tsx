...
const topics = [
  ...
  },
  {
    ...
    icon: <Repeat size={40} className="text-green-600" />,
  },
  ...
  },
  {
    ...
    icon: <Network size={40} className="text-green-600" />,
  },
  {
  ...
  },
  {
    ...
    icon: <Code2 size={40} className="text-green-600" />,
  },
];
...
export default function Hero() {
  ...
  const handleProceed = () => {
    ...
    const selectedQuestions = selectedExams.flatMap(
      (exam) => examOptions[exam].items
    );
    ...
    <section className="flex flex-col items-center min-h-screen justify-center px-6 py-24 sm:py-32 relative">
      ...
      <div className="w-full max-w-4xl text-center space-y-8">
        ...
        <p className="text-md sm:text-lg lg:text-xl text-gray-600 leading-relaxed px-2 sm:px-0">
          ...
          gives you the power to prepare your way—with smart flashcards, real
          exam simulations, and review tools built to help you pass your IT
          exams faster and with confidence.
        </p>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-200 bg-opacity-75 z-50 p-4">
          <div className="bg-white text-gray-900 p-6 rounded-2xl shadow-lg w-100">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2">
                You have unfinished flashcards. Do you wish to continue?
              </p>
            </div>
      ...
      {/* Modal */}
      {showAlert && <MaintenanceAlert onClose={() => setShowAlert(false)} />}
          ...
          <div className="bg-white p-6 rounded-2xl shadow-xl w-full max-w-[550px] max-h-[500px] flex flex-col text-gray-900">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <button
                onClick={() => {
                  if (
                    selectedExams.length === Object.keys(examOptions).length
                  ) {
                    setSelectedExams([]);
                  } else {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="capitalize text-sm font-medium">
                        {exam.replace(/_/g, " ")} - {itemCount} Items
                      </span>
                    </div>
                  );
                })}
            ...
            <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm text-gray-700">
              <span className="mb-3 sm:mb-0">
                ...
                {selectedExams.reduce(
                  (total, exam) => total + (examOptions[exam]?.itemCount || 0),
                  0
                )}{" "}
                Items
              </span>
